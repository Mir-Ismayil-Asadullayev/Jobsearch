...
import navigationsBar from '../../assets/scss/components/navigationsBar.module.scss';
import IconRenderer from '../utils/IconRenderer.jsx';
...
const NavigationsBar = () => {
    ...
    useEffect(() => {
        const resizeObserver = new ResizeObserver(entries => {
            const isSmall = entries[0].contentRect.width <= 196.1875;
            if (isSmall) navigationWrapper.current.classList.add(navigationsBar['navigation-wrapper--burger']);
    ...
    return (
        <div className={navigationsBar['navigations-container']}>
            <div ref={navigationWrapper} className={navigationsBar['navigation-wrapper']}>
                <header className={navigationsBar.header}>
                    <div className={navigationsBar['header__headings']}>
                        <IconRenderer name={'logo'} width={135} height={45} />
                        <Languages />
                    </div>
                    <div className={navigationsBar['categories-navigation']}>
                        <ul>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'bag'} width={20} height={20} color={'rgb(0,0,0)'} />
                                <span>Elanlar</span>
                            </li>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'categories'} width={20} height={20} color={'rgb(0,0,0)'} />
                                <span>Kateqoriyalar</span>
                            </li>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'industries'} width={20} height={20} color={'rgb(0,0,0)'} />
                                <span>Sənaye</span>
                            </li>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'companies'} width={20} height={20} color={'rgb(0,0,0)'} />
                                <span>Şirkətlər</span>
                            </li>
                        </ul>
                    </div>
                    <div className={navigationsBar['subscribe-navigation']}>
                        ...
                        <ul>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'favorite'} width={20} height={20} color={'rgb(0,0,0)'} />
                                <span>Seçilmiş elanlar</span>
                                <span className={navigationsBar['navigation-links__count']}>0</span>
                            </li>
                            <li className={navigationsBar['navigation-links']}>
                                <IconRenderer name={'subscribed categories'} width={20} height={20} color={'rgb(0,0,0)'} />
                    ...
                    <div className={navigationsBar['dark-light-mode']}>
                        <div
                            ...
                            <IconRenderer name={'sun'} width={'50%'} height={'50%'} />
                        </div>
                        <div className={navigationsBar['dark-light-mode__dark']}>
                            <IconRenderer name={'moon'} width={'50%'} height={'50%'} />
                        </div>
                    </div>
                </header>
            ...
            <div className={navigationsBar.resizer}>
                <IconRenderer name={'resizer'} width={25} height={25} />
            </div>
        </div>
    )
}
